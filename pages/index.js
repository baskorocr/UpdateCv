...
export default function Home() {
  ...
  <Box display={{ md: 'flex' }}  mt={{md:40 , base:10}}>
    ...
    <Section delay={0.1}>
        ...
        <Paragraph>
        Mahesa Putra Baskoro is a software developer, in the case of work that I have handled so far is on the market place system, Internet of Things Project and Product Developer in the Research base.  
        </Paragraph>
        <br></br>
        <Paragraph>
        You can see all the projects that I have handled in my github repository below.
        </Paragraph>
        <Box align="center" my={4}>
          <Link href="https://github.com/baskorocr" target="blank" legacyBehavior>
      ...
      <Section delay={0.2}>
        ...
        <BioSection>
          ...
          Bron in Bantul, Yogyakarta , Indonesia.
        </BioSection>
        <BioSection>
      ...
      <Section delay={0.3}>
        ...
        <List display="flex" flexWrap="wrap" >
          ...
          <ListItem w={{base:"50%" ,sm:"fit-content"} }>
            <Link href="https://www.linkedin.com/in/mahesa-putra-baskoro-cahyo-ramadhan-0ab7a6207/" target="_blank">
              <Button
                variant="ghost"
                colorScheme="teal"
      ...
      <Box align="center" my={4}>
          <Link href="https://api.whatsapp.com/send/?phone=6289654825055&text&type=phone_number&app_absent=0" target='blank' legacyBehavior>
            <Button rightIcon={<ChevronRightIcon />} colorScheme="teal">
             My Whatsapp
            </Button>
          </Link>
